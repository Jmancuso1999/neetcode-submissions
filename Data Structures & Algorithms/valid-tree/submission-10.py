...
class Solution:
    def validTree(self, n: int, edges: List[List[int]]) -> bool:
        ...
        # not detecting a cycle just validating the tree itself
        ...
        # Since we are just checking validility of the tree, just start at 0 root
        # We can start anywhere technically, if all aren't visited it will be false
        dfs(0)
